...
class _LoginPage extends State<LoginPage> {
  ...
  startLogin() async {
    String apiurl =
        "http://192.168.29.213/D:/Flutter_Plural/sqfliteb2a/test/login.php"; //api url
  ...
  InputDecoration myInputDecoration({String? label, required IconData icon}) {
    return InputDecoration(
      ...
      enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
              color: Colors.red, width: 1)), //default border of input

      focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(30),
          borderSide: BorderSide(color: Colors.red, width: 1)), //focus border
